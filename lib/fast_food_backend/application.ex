defmodule FastFoodBackend.Application do
  ...
  def start(_type, _args) do
    ...
    opts = [strategy: :one_for_one, name: FastFoodBackend.Supervisor]
  ...
  def config_change(changed, _new, removed) do
    FastFoodBackendWeb.Endpoint.config_change(changed, removed)
    :ok
  end
end
